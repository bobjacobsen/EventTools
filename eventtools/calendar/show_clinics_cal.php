...
<html>
<head>
<title><?php require_once('../access.php'); echo $event_tools_event_name; ?> Clinics Calendar</title>
...
<!-- fire up tinycal box -->
<script type="text/javascript" src="http://<?php echo $path;?>/clinics.config.js"></script>
