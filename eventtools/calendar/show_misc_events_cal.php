...
<html>
<head>
<title><?php require_once('../access.php'); echo $event_tools_event_name; ?> Misc Events Calendar</title>
...
<!-- fire up tinycal box -->
<script type="text/javascript" src="http://<?php echo $path;?>/misc_events.config.js"></script>
