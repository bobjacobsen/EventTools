...
<head>
	...
	<title>Edit Session Pace Constraint</title>
<style type="text/css">
...
<body>
<h3>Edit Session Pace Constraint</h3>
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_session_pace';
...
$opts['fdd']['constrain_id'] = array(
  'name'     => 'Constrain Session Pace ID',
  'select'   => 'T',
...
$opts['fdd']['constrain_value'] = array(
  'name'     => 'Constrain Session Pace value',
  'select'   => 'T',
  'maxlen'   => 25,
  'sort'     => true
);
