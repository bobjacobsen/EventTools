...
<head>
	...
	<title>Edit Car Forwarding Constraint</title>
<style type="text/css">
...
<body>
<h3>Edit Car Forwarding Constraint</h3>
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_car_forwarding';
...
$opts['fdd']['constrain_id'] = array(
  'name'     => 'Constrain Car Forwarding ID',
  'select'   => 'T',
...
$opts['fdd']['constrain_value'] = array(
  'name'     => 'Constrain Car Forwarding value',
  'select'   => 'T',
  'maxlen'   => 25,
  'sort'     => true
);
