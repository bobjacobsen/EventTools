...
function options_select_statement() {
    ...
    $query="
        SELECT customers_firstname, customers_lastname, customers_telephone, customers_cellphone, opsreq_person_email, customers_create_date, customers_updated_date, opsreq_priority
        ";
