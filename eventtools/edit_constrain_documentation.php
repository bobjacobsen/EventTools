...
<head>
	...
	<title>Edit Documentation Constraint</title>
<style type="text/css">
...
<body>
<h3>Edit Documentation Constraint</h3>
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_documentation';
...
$opts['fdd']['constrain_id'] = array(
  'name'     => 'Constrain Documentation ID',
  'select'   => 'T',
...
$opts['fdd']['constrain_value'] = array(
  'name'     => 'Constrain Documentation value',
  'select'   => 'T',
  'maxlen'   => 25,
  'sort'     => true
);
