...
<head>
    ...
    <title><?php require_once('access.php'); echo $event_tools_event_name; ?> Misc Events by Date and Location</title>

    <link href="miscevent.css" rel="stylesheet" type="text/css" />    

</head>
<body>
<h1><?php require_once('access.php'); echo $event_tools_event_name; ?> Misc Events by Date and Location</h1>  
