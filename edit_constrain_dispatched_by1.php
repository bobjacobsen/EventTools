...
<head>
	...
	<title>Edit Dispatched By (primary) Constraint</title>
<style type="text/css">
...
<body>
<h3>Edit Dispatched By (primary) Constraint</h3>
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_dispatched_by1';
...
$opts['fdd']['constrain_id'] = array(
  'name'     => 'Constrain Dispatched By (primary) ID',
  'select'   => 'T',
...
$opts['fdd']['constrain_value'] = array(
  'name'     => 'Constrain Dispatched By (primary) value',
  'select'   => 'T',
  'maxlen'   => 25,
  'sort'     => true
);
