...
<head>
    ...
    <title><?php require_once('access.php'); echo $event_tools_event_name; ?> Misc Event Index</title>

    <link href="tours.css" rel="stylesheet" type="text/css" />    

</head>
<body>
<h2><?php require_once('access.php'); echo $event_tools_event_name; ?> Misc Event Index</h2>  
...
index_misc_events("format_all_misc_events.php#", $where, $order);
