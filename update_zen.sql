...
ALTER TABLE `stlouis2020_customers` ADD `customers_create_date` datetime;
ALTER TABLE `stlouis2020_customers` ADD `customers_updated_date` timestamp ON UPDATE CURRENT_TIMESTAMP
