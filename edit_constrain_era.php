...
<head>
	...
	<title>Edit Era Constraint</title>
<style type="text/css">
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_era';

// Name of field which is the unique key
$opts['key'] = 'constrain_era_id';

// Type of key field (int/real/string/date etc.)
$opts['key_type'] = 'int';

// Sorting field(s)
$opts['sort_field'] = array('constrain_era_id');
