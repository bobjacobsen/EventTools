...
<head>
	...
	<title>Edit Dispatched By (secondary) Constraint</title>
<style type="text/css">
...
<body>
<h3>Edit Dispatched By (secondary) Constraint</h3>
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_dispatched_by2';
...
$opts['fdd']['constrain_id'] = array(
  'name'     => 'Constrain Dispatched By (secondary) ID',
  'select'   => 'T',
...
$opts['fdd']['constrain_value'] = array(
  'name'     => 'Constrain Dispatched By (secondary) value',
  'select'   => 'T',
  'maxlen'   => 25,
  'sort'     => true
);
