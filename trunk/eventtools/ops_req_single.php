...
$opts['fdd']['opsreq_opt1'] = array(
  'name'     => $event_tools_op_session_opt1_long_name,
  'select'   => 'T',
  'maxlen'   => 5,
  'sort'     => true,
  'values'   => array('Y','N')
...
$opts['fdd']['opsreq_opt2'] = array(
  'name'     => $event_tools_op_session_opt2_long_name,
  'select'   => 'T',
  'maxlen'   => 5,
  'sort'     => true,
  'values'   => array('Y','N')
...
$opts['fdd']['opsreq_opt3'] = array(
  'name'     => $event_tools_op_session_opt3_long_name,
  'select'   => 'T',
  'maxlen'   => 5,
  'sort'     => true,
  'values'   => array('Y','N')
...
$opts['fdd']['opsreq_opt4'] = array(
  'name'     => $event_tools_op_session_opt4_long_name,
  'select'   => 'T',
  'maxlen'   => 5,
  'sort'     => true,
  'values'   => array('Y','N')
...
$opts['fdd']['opsreq_opt5'] = array(
  'name'     => $event_tools_op_session_opt5_long_name,
  'select'   => 'T',
  'maxlen'   => 5,
  'sort'     => true,
  'values'   => array('Y','N')
...
if ($event_tools_op_session_opt6_name!=NONE && $event_tools_op_session_opt6_name!='') {
$opts['fdd']['opsreq_opt6'] = array(
  'name'     => $event_tools_op_session_opt6_long_name,
  'select'   => 'T',
  'maxlen'   => 5,
  'sort'     => true,
  'values'   => array('Y','N')
...
$opts['fdd']['opsreq_opt7'] = array(
  'name'     => $event_tools_op_session_opt7_long_name,
  'select'   => 'T',
  'maxlen'   => 5,
  'sort'     => true,
  'values'   => array('Y','N')
...
$opts['fdd']['opsreq_opt8'] = array(
  'name'     => $event_tools_op_session_opt8_long_name,
  'select'   => 'T',
  'maxlen'   => 5,
  'sort'     => true,
  'values'   => array('Y','N')
