...
<head>
	...
	<title>Edit Ops Scheme Constraint</title>
<style type="text/css">
...
<body>
<h3>Edit Ops Scheme Constraint</h3>
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_ops_scheme';
...
$opts['fdd']['constrain_value'] = array(
  'name'     => 'Constrain Ops Scheme value',
  'select'   => 'T',
  'maxlen'   => 25,
  'sort'     => true
);
