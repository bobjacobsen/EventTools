...
<head>
	...
	<title>Edit Communications Constraint</title>
<style type="text/css">
...
<body>
<h3>Edit Communications Constraint</h3>
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_communications';
...
$opts['fdd']['constrain_id'] = array(
  'name'     => 'Constrain Communications ID',
  'select'   => 'T',
...
$opts['fdd']['constrain_value'] = array(
  'name'     => 'Constrain Communications value',
  'select'   => 'T',
  'maxlen'   => 25,
  'sort'     => true
);
