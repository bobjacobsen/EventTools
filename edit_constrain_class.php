...
<head>
	...
	<title>Edit Railroad Class Constraint</title>
<style type="text/css">
...
<body>
<h3>Edit Railroad Class Constraint</h3>
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_class';
...
$opts['fdd']['constrain_id'] = array(
  'name'     => 'Constrain Railroad Class ID',
  'select'   => 'T',
...
$opts['fdd']['constrain_value'] = array(
  'name'     => 'Constrain railroad class value',
  'select'   => 'T',
  'maxlen'   => 25,
  'sort'     => true
);
