...
<head>
	...
	<title>Edit Plan Type Constraint</title>
<style type="text/css">
...
<body>
<h3>Edit Plan Type Constraint</h3>
...
$opts['tb'] = $event_tools_db_prefix.'eventtools_constrain_plan_type';
...
$opts['fdd']['constrain_value'] = array(
  'name'     => 'Constrain Plan Type value',
  'select'   => 'T',
  'maxlen'   => 25,
  'sort'     => true
);
